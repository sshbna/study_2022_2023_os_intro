...
![Обновление пакетов](image/1.png){width=25%}
...
![Программы для удобства работы в консоли](image/2.png){width=25%}
...
![Установка программного обеспечения](image/3.png){width=25%}
...
![Замена значения](image/4.png){width=25%}
...
![Установка средств разработки](image/5.png){width=25%}
...
![Установка пакета DKMS](image/6.png){width=25%}
...
![Создание файла](image/7.png){width=25%}
...
```
![Редактирование файла](image/8.png){width=25%}
...
![Установка имени пользователя и названия хоста](image/9.png){width=25%}
...
![Общая папка](image/10.png){width=25%}
...
![Установка pandoc](image/11.png){width=25%}

## texlive
Установим дистрибутив TeXlive:
dnf -y install texlive-scheme-ful

![Установка texlive](image/12.png){width=25%}
...
![Выполнение команды dmesg](image/12.png){width=25%}
